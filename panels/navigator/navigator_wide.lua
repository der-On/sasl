...
components = {
    ...
    -- clock
    achs1 { position = { 900, 600, 135, 135 }; };
    
    -- vertical speed indicator
    lun_1140_02_8 { position = { 1080, 455, 135, 135 }, },
    
    -- airspeed indicator
    kus_730 { position = { 1080, 310, 135, 135 }, },
    
    -- altitude indicator
    vd_10 { position = { 1080, 165, 135, 135 }, },
    
    -- radio altimeter
    uv_3m { position = { 1080, 20, 135, 135 }, },
    
    -- artifical horizon
    agd_1 { position = { 1080, 600, 135, 135 }, },
    
    -- mach meter
    machmeter { position = { 650, 20, 135, 135 }, },
    ...
    -- large bloody ADF
    un1 { position = { 440, 180, 400, 400 }, },
 
    -- directional gyro
    nav_compas { position = { 890, 400, 180, 180 }, },
    
    -- VOR 1
    vor { position = { 890, 200, 180, 180 }, },
    
    -- VOR 2
    vor { 
        position = { 890, 10, 180, 180 }, 
    ...
    -- DME 1
    dme { position = { 810, 80, 70, 70 }, },
    
    -- DME 2
    dme { 
        position = { 810, 10, 70, 70 }, 
    ...
    ap_switch {  position = { 600, 50, 32, 64 } };
